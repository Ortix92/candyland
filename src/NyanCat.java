...
public class NyanCat extends GameObject implements VisibleObject {
	...
	public double goalX = Math.random() * MazeRunner.maze.MAZE_SIZE *  MazeRunner.maze.SQUARE_SIZE; // where Nyan wants to go
	public double goalZ =  Math.random() * MazeRunner.maze.MAZE_SIZE *  MazeRunner.maze.SQUARE_SIZE;
	...
	public void update(int deltaTime) {
		...
		if (goal) {
			goal(Math.random() * MazeRunner.maze.MAZE_SIZE *  MazeRunner.maze.SQUARE_SIZE, Math.random() * MazeRunner.maze.MAZE_SIZE *  MazeRunner.maze.SQUARE_SIZE);
		}
